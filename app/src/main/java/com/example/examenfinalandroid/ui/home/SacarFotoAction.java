...
public class SacarFotoAction {
    ...
    public SacarFotoAction(Context contexto, Activity activity, NuevoEmpleado nuevoEmpleado){
    ...
    public void openCamera(){
        ...
        if(foto!=null){
            imageUri = FileProvider.getUriForFile(contexto, BuildConfig.LIBRARY_PACKAGE_NAME + ".provider", foto);
